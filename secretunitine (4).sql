...
--
-- Хост: 127.0.0.1
-- Време на генериране: 12 юни 2025 в 20:33
...
--
-- Схема на данните от таблица `message_note`
--

INSERT INTO `message_note` (`messageId`, `noteId`) VALUES
(1, 14),
(1, 16),
(1, 17),
(1, 18),
...
INSERT INTO `notes` (`id`, `content`, `posX`, `posY`) VALUES
(1, 'My note', 569, 390),
(2, 'My note', 569, 390),
(3, 'My note', 518, 293),
(4, 'My note', 536, 399),
...
(8, 'my', 452, 360),
(9, 'My topic', 470, 314),
(10, 'My message', 496, 289),
(11, 'My message', 498, 321),
(12, 'My message', 460, 309),
(13, 'My message', 669, 323),
(14, 'mm', 596, 377),
(15, 'mm', 596, 377),
(16, 'jjj', 470, 303),
(17, 'jjjj', 454, 294),
...
(0, '0MI0600204', 'velinov1@uni-sofia.fmi.bg', '$2y$10$pkV8hAptzSdQEeoFNMnFK.xTuKthqG/d5KMQ1W9xK03', 'velinov1', 'Владимир', 'Великов', 'студент'),
...
(6, '', 'newUser@gmail.com', '$2y$10$qffOEqE4h8HfHLIJfRx/B.luI.uE1J6ZCwRc29iVLm3PAjnFoXPIS', 'newUser', 'NewUserNam', 'NewUserSur', 'teacher');
